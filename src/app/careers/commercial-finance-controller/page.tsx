...
import { Landmark, ArrowLeft, CheckCircle, Send } from "lucide-react";
...
const responsibilities = [
  ...
  "Oversee cash collection and inventory",
  "Enforce same-day banking of all cash received",
  "Enforce a 3-day cap on outstanding collections",
  "Coordinate weekly external reconciliation",
];

export default function CommercialFinanceControllerPage() {
  return (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="relative w-16 h-16 rounded-2xl overflow-hidden bg-white p-3.5 border border-zinc-100 flex items-center justify-center shrink-0">
              <Landmark className="w-full h-full text-zinc-900" />
            </div>
            <div>
      ...
      <section className="py-20 bg-white dark:bg-zinc-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-base">
            Runs sales, distribution, and cash handling under the strict
            financial controls built into the operation.
          </p>
          ...
          <div className="rounded-2xl bg-zinc-900 text-white p-8 sm:p-12 text-center space-y-6 relative overflow-hidden shadow-xl">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto text-sm relative z-10">
              ...
              the Commercial & Finance Controller position.
            </p>
